import { IDetail } from '../model/detail-model';
import { IDetailCard } from '../model/detailCard-model';

export const mockDetailData: IDetail = {
  title: ' Test Title',
...
export const mockDetailCardData: IDetailCard = {
  avengers: {
    title: 'Avengers',
    description:
